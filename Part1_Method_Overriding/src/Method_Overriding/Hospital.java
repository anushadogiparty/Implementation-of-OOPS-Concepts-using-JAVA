...
class Doctor extends HospitalEmployee {
	...
	//To override work() method
	public void work()
	{
	System.out.println (name + " works for the hospital. Micheal is a Heart doctor.");
	}
}
...
class Nurse extends HospitalEmployee {
	...
	public void work()
	{
	System.out.println (name + " works for the hospital. Sonny is a nurse with 6 patients.");
	}
...
class Surgeon extends Doctor{
		...
		public void work()
		{
		System.out.println (name + " works for the hospital. Vincent is operating now.");
		}
